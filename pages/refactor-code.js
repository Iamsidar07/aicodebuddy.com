        ...
        <div className="p-2 md:px-8">
            ...
            <main className="min-h-screen py-4 flex flex-1 flex-col justify-center items-center ">
                ...
                <form onSubmit={onSubmit} className="w-full text-center flex flex-col  md:flex-row max-w-4xl mx-auto space-y-4 md:space-x-2 md:space-y-0 my-14 ">
                    ...
                    />
                    <input type="submit" value={`${loading ? "loading..." : "Refactor Code"}`} className=' textwh bg-blue-600 border-none  text-center cursor-pointer px-10 py-3 rounded-lg' />
                </form>
                {
...

                {
                    result
                    &&
                    <div className={[styles.card, "w-full max-w-7xl mx-auto p-4 bg-gray-900 mb-6 relative"]}>
