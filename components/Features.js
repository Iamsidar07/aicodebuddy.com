        ...
        <div className='max-w-7xl mx-auto mt-20'>
            ...
            <div className="flex items-center justify-center flex-wrap ">
                <Link href="/add-comments" className={styles.card}>
                    <Fade bottom>
                        <div className="w-20 h-20 rounded-full my-4 bg-blue-500 flex items-center justify-center text-white font-bold text-3xl">🗨️</div>
                ...
                >
                    <Fade bottom>
                        <div className="w-20 h-20 rounded-full my-4 bg-yellow-500 flex items-center justify-center text-white font-bold text-3xl">🎃</div>
                ...
                >
                    <Fade bottom>
                        <div className="w-20 h-20 rounded-full my-4 bg-orange-500 flex items-center justify-center text-white font-bold text-3xl">🤖</div>
                ...
                >
                    <Fade bottom>
                        <div className="w-20 h-20 rounded-full my-4 bg-[#f20565] flex items-center justify-center text-white font-bold text-3xl">🐛</div>
                ...
                <Link href="/explain-code" className={styles.card}>
                    <Fade bottom>
                        <div className="w-20 h-20 rounded-full my-4 bg-violet-500 flex items-center justify-center text-white font-bold text-3xl">👩🏿‍🏫</div>
                ...
                >
                    <Fade bottom>
                        <div className="w-20 h-20 rounded-full my-4 bg-white flex items-center justify-center text-white font-bold text-3xl">🪲</div>
                ...
                >
                    <Fade bottom>
                        <div className="w-20 h-20 rounded-full my-4 bg-purple-500 flex items-center justify-center text-white font-bold text-3xl">🙍🏿‍♂️</div>
